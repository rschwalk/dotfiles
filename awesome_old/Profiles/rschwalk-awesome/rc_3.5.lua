--Configume home path so you dont have too
...
--beautiful.init("/home/rschwalk/.config/awesome/themes/grey-new/theme.lua")
beautiful.init("/home/rschwalk/.config/awesome/themes/rschwalk-powerarrow/theme.lua")
...
--for s = 1, screen.count() do
--    -- Each screen has its own tag table.
--    tags[s] = awful.tag({ "1-home", "2-www", "3-files", "4-dev" }, s, layouts[1])
--end
-- }}}
...
myawesomemenu = {
   ...
   --{ "suspend", "gksu 'xlock -mode blank & systemctl suspend'" },
   --{ "hibernate", "xlock -mode blank & systemctl hibernate" },
...
globalkeys = awful.util.table.join(
    ...
    awful.key({                   }, "XF86MonBrightnessUp", function () awful.util.spawn("xbacklight +10")
        local s = awful.util.pread("xbacklight -get")
        naughty.notify({text = "Brightness: " ..s }) end),
    awful.key({                   }, "XF86MonBrightnessDown", function () awful.util.spawn("xbacklight -10")
        local s = awful.util.pread("xbacklight -get")
        naughty.notify({ text = "Brightness: " ..s }) end),
    awful.key({ "Control"         }, "XF86MonBrightnessUp", function () awful.util.spawn("xbacklight =70")
        naughty.notify({text = "Brightness: 70%", ontop = true }) end),
    awful.key({ "Control"         }, "XF86MonBrightnessDown", function () awful.util.spawn("xbacklight =20")
        naughty.notify({ text = "Brightness: 20%", ontop = true }) end),
...
awful.rules.rules = {
    ...
    { rule = { class = "oblogout" },
      callback = awful.client.fullscreen },
    { rule = { class = "gimp" },
      properties = { floating = true } },
