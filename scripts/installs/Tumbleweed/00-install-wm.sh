...
sudo zypper -n install arc-icon-theme
sudo zypper -n install gtk2-metatheme-arc gtk3-metatheme-arc
sudo zypper -n install lxappearance
sudo zypper -n install arandr
sudo zypper -n install noto-mono-fonts
sudo zypper -n install rofi dmenu
sudo zypper -n install compton
sudo zypper -n install nitrogen
sudo zypper -n install noto-sans-mono-fonts
sudo zypper -n install qtile
sudo zypper -n install alacritty
