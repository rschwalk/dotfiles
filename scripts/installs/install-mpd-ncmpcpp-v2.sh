...
##################################################################################################################
# Author 	: 	Erik Dubois
# Modified for OpenSuse Tumbleweed: Richard Schwalk
...
sudo zypper -n in mpd
# sudo pacman -S mpc --noconfirm --needed
sudo zypper -n in mpclient
...
sudo zypper -n in ncmpcpp

mkdir ~/.ncmpcpp
cp /usr/share/doc/packages/ncmpcpp/config ~/.ncmpcpp/config
...
cp /usr/share/doc/packages/ncmpcpp/bindings ~/.ncmpcpp/bindings
