...
battext:set_text("Bat. ")

-- Pacman text
pactext = wibox.widget.textbox()
pactext:set_text("Pac. ")

-- Volume text
voltext = wibox.widget.textbox()
voltext:set_text("Vol. ")
...
vicious.register(cpu, vicious.widgets.cpu, "CPU All: $1% 1: $2% 2: $3% 3: $4% 4: $5%", 2)
-- End CPU }}}
--
-- {{{ Start Mem
...
vicious.register(wifi, vicious.widgets.wifi, "${ssid} Rate: ${rate}MB/s Link: ${link}%", 3, "wlo1")
-- End Wifi }}}
